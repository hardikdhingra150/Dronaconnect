    ...
    <aside className="w-64 min-h-screen bg-white border-r border-gray-100 flex flex-col shadow-sm">
      ...
      <div className="px-6 py-5 border-b border-gray-100">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="font-bold text-gray-900 text-sm leading-none">Attendify</p>
            <p className="text-gray-400 text-[10px] mt-0.5 uppercase tracking-widest">ERP System</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-gray-100">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-gray-500 hover:bg-red-50 hover:text-red-500 transition-all duration-150"
        >
